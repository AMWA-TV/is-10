...
The Authorization Server MUST support advertising itself using unicast DNS-SD.
...
Clients and Resource Servers MUST support discovering the Authorization Server through use of unicast DNS-SD service discovery, as described in [RFC 6763](https://tools.ietf.org/html/rfc6763).
