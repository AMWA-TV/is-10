...
Authorization. Where possible clients should be responded to directly in order to avoid redirecting to an endpoint which
exhibits different Authorization claim requirements.
