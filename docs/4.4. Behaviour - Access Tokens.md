...
StringOrURI value that identifies the Authorization Server that issued the JWT. The value of this claim SHOULD be the
DNS name and port of the Authorization Server accessible to the audience of the token. The contents of this claim
