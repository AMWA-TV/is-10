...
case of a device restart to prevent duplicate registrations. Client secrets SHOULD be hashed before being stored to
...
Server's authorization endpoint, to easily facilitate the authorising of NMOS devices.
