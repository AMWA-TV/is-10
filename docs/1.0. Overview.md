...
This document defines the mechanism for authorization of clients and/or users which need to access or modify resources
...
*   _Draft JWT BCPs <https://datatracker.ietf.org/doc/draft-ietf-oauth-jwt-bcp/>_
*   _Draft OAuth 2 security best practice <https://datatracker.ietf.org/doc/draft-ietf-oauth-security-topics/>_
