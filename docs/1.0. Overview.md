...
be used alongside NMOS APIs with zero or minimal modification.
...
*   Refresh Token Grant
*   Implicit Grant _(Deprecated)_
*   Resource Owner Password Credentials Grant _(Deprecated)_
*   Client Credentials Grant _(Deprecated)_
