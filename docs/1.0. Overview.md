...
Familiarity with the [JT-NM reference architecture](https://jt-nm.org/RA-1.0/) is assumed, and further definitions of
OAuth 2.0 concepts as they apply to NMOS are found in both the [Definitions](5.0.%20Definitions.md) section and the
...
[BCP-003-01]: https://amwa-tv.github.io/nmos-secure-communication/ "AMWA BCP-003-01 Secure Communication in NMOS Systems"
