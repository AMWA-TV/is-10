...
*   [RFC 7515][RFC-7515] - JSON Web Signature (JWS) _<- Confirm if used directly or via another RFC_
*   [RFC 7517][RFC-7517] - JSON Web Key (JWK)
*   [RFC 7519][RFC-7519] - JSON Web Token (JWT)
*   [RFC 7523][RFC-7523] - JSON Web Token (JWT) Profile for OAuth 2.0 Client Authentication and Authorization Grants _<- Confirm - what about JWT profile for OAuth2 access tokens https://tools.ietf.org/html/draft-ietf-oauth-access-token-jwt-02_
...
*   _Draft resource indicators?_
*   _Draft mutual TLS?_
*   _Draft JWT BCPs_
*   _Draft OAuth 2 security best practice_
